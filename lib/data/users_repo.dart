...
class UsersRepo {
  ...
  Future<UpdateResponse> updateCurrentUser(UpdateRequest request) async {
    Map updateResponse = await HttpWrapper().httpPut("users", request.toJson());
    print("Update response");
    print(updateResponse);
    return UpdateResponse.fromJson(updateResponse);
  }
}
